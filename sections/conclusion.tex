    ...
    \begin{center}
      ...
      \begin{tikzpicture}[node distance=1cm, auto,>=stealth, thick]
        ...
        \path[->]<2-> node[proc, below of=Loss, text width=48ex,
          yshift=-.225in, xshift=0in] (Comment) {The empirical study
          demonstrates that {\em Schema\-Analyst}'s efficiency is
          competitive with {\em DBMonster}'s};

        \path[->]<3-> node[proc, below of=Comment, text width=48ex,
          yshift=-.1in, xshift=0in] (CommentAgain) {{\em
